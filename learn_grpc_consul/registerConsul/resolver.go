...
func (cc *consulClientConn) ParseServiceConfig(serviceConfigJSON string) (ret *serviceconfig.ParseResult){
    cc.json = serviceConfigJSON

    ret  = &serviceconfig.ParseResult{}
    return
}

func (cc *consulClientConn) UpdateState(ret resolver.State) {
